...
public class CarSparkStreaming {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		kafkaParams.put("bootstrap.servers", "localhost:9092,localhost:9093,localhost:9094"); //BROKERS
		kafkaParams.put("key.deserializer", StringDeserializer.class);
		kafkaParams.put("value.deserializer", StringDeserializer.class);
		kafkaParams.put("group.id", "car-data-consumer-group");
		kafkaParams.put("auto.offset.reset", "earliest");
		kafkaParams.put("enable.auto.commit", false);

		Collection<String> topics = Arrays.asList("carMultiBroker"); //KAFKA TOPIC NAME
